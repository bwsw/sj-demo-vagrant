...
echo "cpus:2;mem:3072;disk:1024;ports:[8888-8888];ports:[9092-9092];ports:[7203-7203];ports:[31071-31071];ports:[5601-5601];ports:[9200-9200];ports:[9300-9300];ports:[27017-27017]" | sudo tee /etc/mesos-slave/resources
